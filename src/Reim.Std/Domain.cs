...
//    Task<Result<T, E>> Create(IValidater<T> repo);
//    Task<Result<T, E>> Update(IValidater<T> repo, I id);
//}
...
public record Errors {
    ...
    public Errors() { _dic = new Dictionary<string, string>(); }
    public Errors(IDictionary<string, string> dic) { _dic = dic; }
